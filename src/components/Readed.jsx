      ...
      <div className="w-full flex-col justify-start items-start gap-4">
        ...
        <div className="justify-start items-start gap-3 flex flex-col lg:flex-row">
          ...
          <Link to={`book-details/${bookId}`}>
            <button
              onClick={handleReadBookDetails}
              className="px-5 py-2 w-full lg:w-auto bg-green-600 rounded-[30px] text-center text-white text-lg font-medium font-['Work Sans'] cursor-pointer active:scale-90 duration-150 border-2 border-green-600 hover:text-green-600 hover:bg-[#fff0]"
            >
              View Details
            </button>
          </Link>
